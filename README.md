...
rnbuilder/0.0.3 darwin-x64 node-v12.19.1
...
_See code: [src/commands/build.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.0.3/src/commands/build.ts)_
...
_See code: [src/commands/initialize.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.0.3/src/commands/initialize.ts)_
<!-- commandsstop -->
