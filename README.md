...
rnbuilder/0.6.28 darwin-arm64 node-v18.18.0
...
OPTIONS
  ...
  -e, --env=staging|dev|prod           Set the environment: prod, staging, dev
  ...
  -t, --target=android|ios|both        Set the build target: android, ios or both
...
_See code: [src/commands/build.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/build.ts)_
...
_See code: [src/commands/check-version.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/check-version.ts)_
...
_See code: [src/commands/codepush.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/codepush.ts)_
...
_See code: [src/commands/google-key.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/google-key.ts)_
...
_See code: [src/commands/initialize.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/initialize.ts)_
...
_See code: [src/commands/match-check.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/match-check.ts)_
...
_See code: [src/commands/match-nuke.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/match-nuke.ts)_
...
_See code: [src/commands/onesignal.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/onesignal.ts)_
...
_See code: [src/commands/setup.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/setup.ts)_
...
_See code: [src/commands/submit-review.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/submit-review.ts)_
...
_See code: [src/commands/sync-udids.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.28/src/commands/sync-udids.ts)_
<!-- commandsstop -->
