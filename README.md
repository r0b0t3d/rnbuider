...
rnbuilder/0.6.73 darwin-arm64 node-v24.13.0
...
OPTIONS
  ...
  -n, --install                         Install dependencies before building
...
_See code: [src/commands/build.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/build.ts)_
...
_See code: [src/commands/check-version.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/check-version.ts)_
...
_See code: [src/commands/codepush.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/codepush.ts)_
...
_See code: [src/commands/google-key.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/google-key.ts)_
...
_See code: [src/commands/initialize.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/initialize.ts)_
...
OPTIONS
  -c, --client=client  Select client that you want to check match certificates
  -h, --help           show CLI help
...
_See code: [src/commands/match-check.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/match-check.ts)_
...
_See code: [src/commands/match-nuke.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/match-nuke.ts)_
...
_See code: [src/commands/onesignal.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/onesignal.ts)_

## `rnbuilder reject-review [REJECT-REVIEW]`

Reject current App Store review version (In Review or Pending Developer Release)
...
OPTIONS
  -c, --client=client  Select client to reject App Store review version
  -h, --help           show CLI help
...
_See code: [src/commands/reject-review.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/reject-review.ts)_
...
_See code: [src/commands/setup.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/setup.ts)_
...
_See code: [src/commands/setup-gcp.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/setup-gcp.ts)_
...
_See code: [src/commands/submit-review.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/submit-review.ts)_
...
_See code: [src/commands/sync-udids.ts](https://github.com/r0b0t3d/rnbuilder/blob/v0.6.73/src/commands/sync-udids.ts)_
<!-- commandsstop -->
